        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">FarmTrack</span>
              </Link>
            </div>
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <div className="relative">
              <button
                type="button"
                className="p-1 rounded-full text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 relative"
                onClick={() => {
            ...
            <div className="ml-3 relative">
              <div>
                <button
                  type="button"
                  className="flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 items-center"
                  onClick={() => {
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="flex items-center px-4">
              ...
              <div className="ml-3">
                ...
                <div className="text-sm font-medium text-gray-500">admin@farmtrack.com</div>
              </div>
              <button
                type="button"
              ...
              >
                <Bell className="h-6 w-6" />
                {unreadNotifications.length > 0 && (
                  <span className="absolute top-3 right-3 block h-2 w-2 rounded-full bg-red-500 ring-2 ring-white"></span>
                )}
              </button>
            </div>
